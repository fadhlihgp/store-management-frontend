...
export const TopSideButtons = ({onClick, onChangeInput, placeHolder, componentChildren, showInput = true}: TopSideButtonsProps) => {
    ...
    return(
        <div className="float-right flex gap-2 items-end flex-col md:flex-row">
            ...
            {!componentChildren && (
                <button className="btn px-6 btn-sm normal-case btn-success text-slate-100" onClick={onClick}>Tambah Data</button>
            )}
        </div>
    )
}
