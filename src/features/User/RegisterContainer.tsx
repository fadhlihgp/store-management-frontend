                ...
                <div className="grid  md:grid-cols-2 grid-cols-1  bg-base-100 rounded-xl">
                    ...
                    <div className='py-24 px-10'>
                        ...
                        <form onSubmit={(e) => submitForm(e)}>
                            ...
                            <div className='text-center mt-4'>Sudah punya akun? <Link to="/login"><span className="  inline-block  hover:text-primary hover:underline hover:cursor-pointer transition duration-200">Login</span></Link></div>
                        </form>
                    </div>
                </div>
            </div>
