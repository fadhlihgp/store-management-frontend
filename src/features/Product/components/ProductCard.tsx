...
export const ProductCard = ({name, price, onClickDelete, onClickDetail, imageUrl, unit}: ProductCardProps) => {
    return(
        <div className="card card-compact bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <p className={'font-semibold text-lg'}>{convertCurrency("Rp", price)}/<span className="text-md">{unit}</span> </p>
